...
class DBI {
   ...
   * @see filter
   */
  public function getAll(DBObject $obj, DBExpression $where = null) {
    $r = $this->query($this->prepGetAll($obj, $where));
   ...
   * @see prepGet
   */
  public function prepGetAll(DBObject $obj, DBExpression $where = null, Array $fields = array()) {
